# Алгоритмы и структуры данных: Множества на основе битовых полей
...
репозиторий, содержащий следующее:
...
Выполнение работы предполагает решение следующих задач:
  ...
  1. PR своего решения в исходный репозиторий и последующее Code Review
...
Структура проекта:
  ...
  - `solutions` — директория для размещения реализаций студентов.
...
## Инструкция по выполнению работы
  ...
  1. Освоение общих принципов работы с Git и GitHub. Последовательность
     ...
     - Создание форка этого репозитория с проектом-шаблоном,
       размещенного на GitHub
     - Клонирование форка из своего личного пространства на GitHub к себе на
       рабочую машину
     - Создание новой ветки, добавление личного рабочего директория, внесение
       некоторых изменений (например в файл `README.md`)
  ...
  1. Ваше итоговое решение должно находиться в папке `solutions` в подпапке с вашей
...
[git-guide]:   https://github.com/EvgenyPinezhanin/itmm-aads-lab1-set-2025/tree/master/docs/part1-git.md
[gtest-guide]: https://github.com/EvgenyPinezhanin/itmm-aads-lab1-set-2025/tree/master/docs/part2-google-test.md
